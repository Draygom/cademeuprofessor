...
include("menu.php");
    ...
    $tipo_usuario = stripslashes($_REQUEST['tipo_usuario']);
    $tipo = mysqli_real_escape_string($con, $tipo_usuario);
		$data = date("Y-m-d H:i:s");
        $query = "INSERT into `usuarios` (apelido, tipo_usuario_id_tipo_usuario, nome, password, email, data_cadastro) VALUES ('$apelido', '$tipo_usuario', 'nome', '".md5($password)."', '$email', '$data')";
...
<div class="container-fluid col-6">
  ...
  <form name="registration" action="" method="post">
    <input type="hidden" class="" name="tipo_usuario" value="1" />
