...
<div class="container-fluid">
  <h5 style="text-align:center;">Escolha o Curso</h5>
  <br>
  <div class="card mb-3 mx-auto rounded-1 col-sm" style="align:center;">
    <div class="row" role="group" aria-label="Grupo do painel">
      ...
      while ($resultado = mysqli_fetch_array($query)) {
          ?>
      <a href="regist_disc.php?c=<?php echo $resultado["nome_curso"] ?>" class="btn btn-secondary rounded-0 col-6 col-sm-3"><?php echo $resultado["nome_curso"] ?></a>
    <?php } ?>
    </div>
  </div>
